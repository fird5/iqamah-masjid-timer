...
It was all manual originally with no timer, no display. 

The call to iqamah was left to whoever was leading prayer that solat, which meant timing varied slightly from imam to imam. 
